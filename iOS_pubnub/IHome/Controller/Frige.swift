...
class Frige:  UIViewController, UITableViewDataSource {
    
    private var cellIdentifier = "TasksCell"
    var listName: String? = "Frige"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier) as? FridgeCell
        if cell == nil {
            cell = UITableViewCell(style: .default, reuseIdentifier: cellIdentifier) as? FridgeCell
        }
    ...
    private func alertForAddingItems() -> UIAlertController {
        let alertController =  IHome.Alert(title: "Please provide the Item name",
