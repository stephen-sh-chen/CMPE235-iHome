...
class Fan: UIViewController, UITableViewDataSource {
    
    private var cellIdentifier = "TasksCell"
    var listName: String? = "Fans"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier) as? FanCell
        if cell == nil {
            cell = UITableViewCell(style: .default, reuseIdentifier: cellIdentifier) as? FanCell
        }
    ...
    private func alertForAddingItems() -> UIAlertController {
        let alertController =  IHome.Alert(title: "Please provide the Fan name",
