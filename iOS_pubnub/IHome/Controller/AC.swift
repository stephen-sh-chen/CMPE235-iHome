...
class AC: UIViewController, UITableViewDataSource {
    
    private var cellIdentifier = "TasksCell"
    var listName: String? = "AC"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier) as? ACCell
        if cell == nil {
            cell = UITableViewCell(style: .default, reuseIdentifier: cellIdentifier) as? ACCell
        }
    ...
    private func alertForAddingItems() -> UIAlertController {
        let alertController =  IHome.Alert(title: "Please provide the AC name",
